...
class ArtisScreen extends StatefulWidget {
  ...
  const ArtisScreen({super.key, required this.documentId, required this.name, required this.lines});
...
class _ArtisScreenState extends State<ArtisScreen> {
  ...
  Widget displayArtiDetails(DocumentSnapshot snapshot) {
    ...
    if (data == null) {
      return Center(child: Text('कृपया अपना इंटरनेट चालू करें और\n पुनः प्रयास करें',style: TextStyle(
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return SizedBox(
            ...
            child: Column(
              children: [
                Text(data[widget.lines[index]]as String,style: const TextStyle(color: baseColor,fontSize: 20,fontFamily: 'hind_medium',),textAlign: TextAlign.center
                  ,),
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          onTap: () {
            ...
            child: Icon(Icons.arrow_back_ios_new_rounded,color: baseColor.shade200,)),

        centerTitle: true,
        title: Text(widget.name,style: TextStyle(color: baseColor.shade300,fontSize: 26),),
      ),
      body: Container(
              ...
              child:Padding(
                ...
                child: StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData) {
                      return  Center(child: Text('कुछ तकनीकी समस्या है,\n' 'कृपया व्यवस्थापक से बात करें',style: TextStyle(
                        color: baseColor.shade900,
                        fontSize: 20,
                        fontFamily: 'hind'
